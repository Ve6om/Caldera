    ...
    event
        ...
        .addWeightedLoot(
            ...
            [
                ...
                LootEntry.of("potionring:potion_ring").withChance(2),
                LootEntry.of("potionring:ring_of_speed").withChance(2),
                LootEntry.of("potionring:ring_of_jump_boost").withChance(2),
                LootEntry.of("potionring:ring_of_haste").withChance(2),
                LootEntry.of("potionring:ring_of_regeneration").withChance(3),
                LootEntry.of("potionring:ring_of_jump_resistance").withChance(2),
                LootEntry.of("potionring:ring_of_jump_strength").withChance(2),
